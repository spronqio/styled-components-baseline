...
var Section = styled.div(_templateObject2, function (props) {
...
var SingleMeasure = styled.div(_templateObject3, function (props) {
  return props.theme.sb.measure('all');
});
var Column = styled.div(_templateObject4, function (props) {
...
var ColumnDuo = Column.extend(_templateObject5, function (props) {
  return props.theme.sb.breakpoint('break-1')("width: 50%;\n\n&:nth-of-type(2n+3) {\n  clear: left;\n}\n\n&:nth-of-type(n+3) {\n  margin-top: 3rem;\n}");
});
var ColumnTrio = Column.extend(_templateObject6, function (props) {
...
export { Paragraph, Section, SingleMeasure, Column, ColumnDuo, ColumnTrio };
